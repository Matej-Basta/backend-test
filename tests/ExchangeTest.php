...
class ExchangeTest extends TestCase {
    ...
    public function setUp(): void {
        ...
        $this->exchangeCurrencies = new Exchange("https://api.apilayer.com/currency_data/list", "https://api.apilayer.com/currency_data/convert?to=placeholderTo&from=placeholderFrom&amount=placeholderAmount", "kigiQGomtNhg3zsoWOb6LYcKRuhQp2fM");
    }
    ...
    /* public function getAmountValidInputTest() {
        $amount = $this->exchangeCurrencies->getAmount(100, 'EUR', 'DKK');
